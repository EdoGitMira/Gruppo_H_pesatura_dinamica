...
url = 'https://raw.githubusercontent.com/EdoGitMira/Gruppo_H_pesatura_dinamica/tree/main/dati'
...
if __name__ == '__main__':
    ...
    #PlotFilesData.prepare_arrays(voltage, grams)
    PlotFilesData.prepare_arrays(means,masses)
